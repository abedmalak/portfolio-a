...
import Play from '../public/assets/skills/play.jpg';
import Mobile from '../public/assets/skills/mobile.png';
import Backend from '../public/assets/skills/backend.png';
import Frontend from '../public/assets/skills/frontend.jpg';
      ...
      <div className='max-w-[1240px] mx-auto flex flex-col justify-center h-full'>
        ...
        <div className='grid grid-cols-2 lg:grid-cols-4 gap-8'>
          ...
          <div className='p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300'>
            <div className='grid grid-cols-2 gap-4 justify-center items-center'>
              <div className='m-auto'>
                <Image src={Mobile} width='64px' height='64px' alt='/' />
              </div>
              <div className='flex flex-col items-center justify-center'>
